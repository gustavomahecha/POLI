...
public class GenerateInfoFiles {
    ...
    //Se creab 5 arreglos para realizar las pruebas de generacion de archivos, los 3 primeros son de los vendedores y los 2 ultimos de los productos
    ...
    private static final String[] TIPOS_DOC = {"CC", "CE", "TI", "PP"};
