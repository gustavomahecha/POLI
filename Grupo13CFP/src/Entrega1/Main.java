...
/*Bloque para importar las librerias */
...
class Producto {
    //Identificacion de los productos disponibles
...
public class Main {
    ...
    private static  Map cargarDatos(String archivo, java.util.function.Function constructor, java.util.function.Function getKey) throws IOException {
        ...
        return (Map) Files.lines(Paths.get(archivo)).map(constructor).collect(Collectors.toMap(getKey, item -> item));
